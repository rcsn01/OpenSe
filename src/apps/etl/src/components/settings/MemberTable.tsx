...
import { OrganisationMembersTable, Select, type OrganisationMembersTableRow } from '@repo/ui';
...
export const MemberTable: React.FC<MemberTableProps> = ({
  ...
  const rows: OrganisationMembersTableRow[] = members.map((member) => {
    ...
    return {
      ...
      permissionsRoleContent: isOwner ? (
      ...
      actionsContent: !isOwner && canManage ? (
        <button
