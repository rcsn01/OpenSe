...
import type { OpenSeAssistantBridge } from '../lib/assistantBridge'
...
const createBridge = (): OpenSeAssistantBridge =>
  ({
  ...
  }) as unknown as OpenSeAssistantBridge
...
const renderTerminal = (bridge: OpenSeAssistantBridge, theme: 'light' | 'dark' = 'light') => {
