...
export const AssistantWorkspace = () => {
  ...
  const shell = (
    <AppShellLayout
      brand={{ icon: <Bot />, name: 'Open Pi', version: 'v1' }}
              ...
              <div className="grid min-h-0 flex-1 place-items-center p-6">
                <div className="max-w-md">
                  <EmptyState
                    ...
                    description="Open Pi starts Pi in the selected workspace and keeps that session visible across app restarts."
                  />
              ...
              <>
                ...
                <form onSubmit={sendCommand} className="p-3">
                  ...
                  <div className="rounded-[var(--radius-md)] border border-[var(--color-border)] bg-transparent px-3 py-2 focus-within:ring-2 focus-within:ring-[var(--color-ring)]">
                    <label className="sr-only" htmlFor="pi-command">
                      Send command
                    </label>
                    <textarea
                      ref={commandInputRef}
