...
export function DialogContent({
  ...
  return (
    <div
      className={cn(
        "rounded-[var(--radius-2xl)] bg-[color:color-mix(in_srgb,var(--color-card)_94%,transparent)] p-6 shadow-[var(--shadow-xl)] backdrop-blur-xl",
        className,
      )}
    >
      <button
        ...
        onClick={onClose}
        className="absolute right-4 top-4 rounded-full p-1.5 opacity-70 transition-colors hover:bg-[var(--color-muted)] hover:opacity-100"
      >
        <X className="h-4 w-4" />
      </button>
      {children}
