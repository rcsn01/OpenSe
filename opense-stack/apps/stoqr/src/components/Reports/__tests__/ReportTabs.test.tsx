...
vi.mock('../../../hooks/queries/useReports', () => ({
  ...
  useAuditShrinkageData: (...args: unknown[]) => mocks.useAuditShrinkageData(...args),
}))
...
vi.mock('../../../hooks/queries/useProcurementTabs', () => ({
  ...
  useProcurementOrderHistory: (...args: unknown[]) => mocks.useProcurementOrderHistory(...args),
  useProcurementReceivingLogs: (...args: unknown[]) => mocks.useProcurementReceivingLogs(...args),
}))
  ...
  transactions: [
    {
      ...
      performed_by: 'user-1',
      products: { id: 'prod-1', name: 'PCR Tips', sku: 'TIP-001', cost_price: 15, selling_price: 40 },
    ...
    },
    {
      ...
      performed_by: 'user-2',
      products: { id: 'prod-2', name: 'Safe-Lock Tubes', sku: 'TUBE-002', cost_price: 9, selling_price: 18 },
    ...
    },
    {
      ...
      notes: 'Outbound shipment',
      performed_by: 'user-3',
      products: { id: 'prod-3', name: 'Caviwipes', sku: 'WIP-003', cost_price: 28, selling_price: 62 },
  ...
  discrepancies: [
    {
      ...
      products: { id: 'prod-a', name: 'Electrodes', sku: 'ELC-112', cost_price: 15, selling_price: 30 },
    },
    {
      id: 'disc-2',
      ...
      products: { id: 'prod-b', name: 'Apparel Kit', sku: 'APP-099', cost_price: 12, selling_price: 26 },
    },
    {
      id: 'disc-3',
      transaction_type: 'adjustment',
      ...
      products: { id: 'prod-c', name: 'Fit Count', sku: 'FIT-004', cost_price: 8, selling_price: 16 },
    },
    {
      id: 'disc-4',
      transaction_type: 'adjustment',
      ...
      products: { id: 'prod-d', name: 'Food Sample', sku: 'FOD-882', cost_price: 4, selling_price: 12 },
    },
  ],
  sales: [
    {
...
beforeEach(() => {
  ...
  mocks.useProcurementPurchaseOrders.mockReturnValue({ data: [
    { id: 'po-open', po_number: 1002, supplier_id: 'sup-2', status: 'sent', expected_date: '2026-04-20', created_at: '2026-04-10T00:00:00Z' },
    { id: 'po-closed-2', po_number: 1001, supplier_id: 'sup-1', status: 'closed', expected_date: '2026-04-05', created_at: '2026-04-02T00:00:00Z' },
  ] })
  mocks.useProcurementOrderHistory.mockReturnValue({ data: [
    { id: 'po-closed-1', po_number: 1000, supplier_id: 'sup-1', status: 'closed', expected_date: '2026-03-12', created_at: '2026-03-01T00:00:00Z' },
    { id: 'po-closed-2', po_number: 1001, supplier_id: 'sup-1', status: 'closed', expected_date: '2026-04-05', created_at: '2026-04-02T00:00:00Z' },
  ] })
  mocks.useProcurementPurchaseOrderItems.mockReturnValue({ data: [
    {
      id: 'item-1',
      po_id: 'po-closed-1',
      product_id: 'prod-1',
      ...
      purchase_orders: { id: 'po-closed-1', po_number: 1000, status: 'closed', expected_date: '2026-03-12' },
    },
    {
      id: 'item-2',
      po_id: 'po-closed-2',
      ...
      unit_cost: 125,
      products: { id: 'prod-1', name: 'PCR Tips', sku: 'TIP-001' },
      purchase_orders: { id: 'po-closed-2', po_number: 1001, status: 'closed', expected_date: '2026-04-05' },
    },
    {
      id: 'item-3',
      po_id: 'po-open',
      ...
      unit_cost: 129,
      products: { id: 'prod-1', name: 'PCR Tips', sku: 'TIP-001' },
      purchase_orders: { id: 'po-open', po_number: 1002, status: 'sent', expected_date: '2026-04-20' },
    },
  ] })
  mocks.useProcurementReceivingLogs.mockReturnValue({ data: [
    {
      id: 'log-1',
      po_id: 'po-closed-1',
      product_id: 'prod-1',
...
describe('report tabs', () => {
  ...
  it('renders custom reports builder and saves a new template locally', () => {
    ...
    expect(screen.getAllByText('Weekly Stockout Warning')).toHaveLength(2)
