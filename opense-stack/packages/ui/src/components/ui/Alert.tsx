...
const alertVariants = cva('relative flex gap-3 rounded-[var(--radius-lg)] border p-4 text-sm', {
  variants: {
    variant: {
...
const iconMap = { info: Info, success: CheckCircle2, warning: AlertTriangle, destructive: AlertCircle }

export interface AlertProps extends VariantProps<typeof alertVariants> {
  children: ReactNode; title?: string; className?: string; dismissible?: boolean; onDismiss?: () => void
}
